...
function doubleMetaphone(word) {
  ...
  while (true) {
    ...
    if (method) {
      ...
      var _method$ = _method[0];
      var one = _method$ === undefined ? null : _method$;
      var _method$2 = _method[1];
      var two = _method$2 === undefined ? null : _method$2;
      var _method$3 = _method[2];
      var newOffset = _method$3 === undefined ? 1 : _method$3;
