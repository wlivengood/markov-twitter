...
function phonetic(word) {
  ...
  for (var i = 0, l = FIRST_PREPROCESSING.length; i < l; i++) {
    ...
    var pattern = _FIRST_PREPROCESSING$[0];
    var replacement = _FIRST_PREPROCESSING$[1];
  ...
  for (var _i = 0, _l = SECOND_PREPROCESSING.length; _i < _l; _i++) {
    ...
    var pattern = _SECOND_PREPROCESSING[0];
    var replacement = _SECOND_PREPROCESSING[1];
  ...
  for (var _i2 = 0, _l2 = RULES.length; _i2 < _l2; _i2++) {
    ...
    var pattern = _RULES$_i[0];
    var replacement = _RULES$_i[1];
  ...
  for (var _i3 = 0, _l3 = FIRST_ENDINGS.length; _i3 < _l3; _i3++) {
    ...
    var pattern = _FIRST_ENDINGS$_i[0];
    var replacement = _FIRST_ENDINGS$_i[1];
  ...
  for (var _i4 = 0, _l4 = SECOND_ENDINGS.length; _i4 < _l4; _i4++) {
    ...
    var pattern = _SECOND_ENDINGS$_i[0];
    var replacement = _SECOND_ENDINGS$_i[1];
