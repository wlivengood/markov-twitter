...
var PunktLanguageVariables = exports.PunktLanguageVariables = function () {
  ...
  _createClass(PunktLanguageVariables, [{
    key: 'tokenizeWords',
    value: function tokenizeWords(string) {
...
var PunktParameters = function () {
  ...
  _createClass(PunktParameters, [{
    key: 'addOrthographicContext',
    value: function addOrthographicContext(type, flag) {
...
var PunktToken = exports.PunktToken = function () {
  ...
  _createClass(PunktToken, [{
    key: 'typeNoPeriod',
    value: function typeNoPeriod() {
    ...
    key: 'typeNoSentencePeriod',
    value: function typeNoSentencePeriod() {
...
var PunktBaseClass = exports.PunktBaseClass = function () {
  function PunktBaseClass(options) {
    ...
    var _ref$vars = _ref.vars;
    var vars = _ref$vars === undefined ? new PunktLanguageVariables() : _ref$vars;
    var _ref$params = _ref.params;
    var params = _ref$params === undefined ? new PunktParameters() : _ref$params;
  ...
  _createClass(PunktBaseClass, [{
    key: 'tokenizeWords',
    value: function tokenizeWords(text) {
    ...
    key: '_annotateFirstPass',
    value: function _annotateFirstPass(tokens) {
...
var PunktTrainer = exports.PunktTrainer = function (_PunktBaseClass) {
  ...
  function PunktTrainer(options) {
    ...
    var _this = _possibleConstructorReturn(this, (PunktTrainer.__proto__ || Object.getPrototypeOf(PunktTrainer)).call(this, options));
  ...
  _createClass(PunktTrainer, [{
    key: '_getOrthographyData',
    value: function _getOrthographyData(tokens) {
    ...
    key: '_reclassifyAbbreviationType',
    value: function _reclassifyAbbreviationType(type) {
      var isAdd = void 0;
    ...
    key: '_isRareAbbreviationType',
    value: function _isRareAbbreviationType(currentToken, nextToken) {
    ...
    key: '_isPotentialCollocation',
    value: function _isPotentialCollocation(firstToken, secondToken) {
    ...
    key: '_findCollocations',
    value: function _findCollocations() {
      ...
      for (var i = 0, l = types.length; i < l; i++) {
        ...
        var type1 = _hash$split[0];
        var type2 = _hash$split[1];
    ...
    key: '_isPotentialSentenceStarter',
    value: function _isPotentialSentenceStarter(token, previousToken) {
    ...
    key: '_findSentenceStarters',
    value: function _findSentenceStarters() {
    ...
    value: function finalize() {
      ...
      for (var i = 0, l = sentenceStarters.length; i < l; i++) {
        ...
        var type = _sentenceStarters$i[0];
        var ll = _sentenceStarters$i[1];
      ...
      for (var _i4 = 0, _l4 = collocations.length; _i4 < _l4; _i4++) {
        ...
        var hash = _collocations$_i[0];
        var ll = _collocations$_i[1];
...
var PunktSentenceTokenizer = exports.PunktSentenceTokenizer = function (_PunktBaseClass2) {
  ...
  function PunktSentenceTokenizer(params) {
    ...
    var _this2 = _possibleConstructorReturn(this, (PunktSentenceTokenizer.__proto__ || Object.getPrototypeOf(PunktSentenceTokenizer)).call(this));
  ...
  _createClass(PunktSentenceTokenizer, [{
    key: '_orthographicHeuristic',
    value: function _orthographicHeuristic(token) {
    ...
    key: '_annotateSecondPass',
    value: function _annotateSecondPass(tokens) {
    ...
    key: '_annotateTokens',
    value: function _annotateTokens(tokens) {
    ...
    key: '_textContainsSentenceBreak',
    value: function _textContainsSentenceBreak(text) {
      var tokens = this.tokenizeWords(text);
    ...
    key: '_slicesFromText',
    value: function _slicesFromText(text) {
      var slices = [],
    ...
    key: '_realignBoundaries',
    value: function _realignBoundaries(text, slices) {
      var realigned = [];
    ...
    key: 'spanTokenize',
    value: function spanTokenize(text) {
