...
function minimal(word) {
  ...
  if (lastLetter === 'o' || lastLetter === 'a' || lastLetter === 'e') return word.slice(0, -1);

  if (lastLetter === 's') {
    var l2 = word[word.length - 2],
        l3 = word[word.length - 3],
        l4 = word[word.length - 4];

    if (l2 === 'e' && l3 === 's' && l4 === 'e') return word.slice(0, -2);
    ...
    if (l2 === 'o' || l2 === 'a' || l2 === 'e') return word.slice(0, -2);
  }
